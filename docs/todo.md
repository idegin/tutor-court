# Todo
1. Create a const that holds the min credit the tutor has to have on the live classroom to show them a shadcn alert popup when they are flow on credits. we store the initial total amount.
...
4. Make sure "Main Board" is never created for a class.