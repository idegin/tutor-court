            ...
            case "welcome":
                return (
                    <div className="flex h-full w-full flex-col justify-end pb-12">
                        <div className="relative w-full max-w-[480px] overflow-hidden rounded-[2rem] border border-white/5 bg-[#1F292E]/60 p-10 pb-12 shadow-2xl backdrop-blur-md">
                            <div className="mb-6">
                ...
                return (
                    <div className="flex h-full w-full items-center justify-center">
                        <div className="relative group perspective-1000">
                            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 opacity-20 blur-xl transition duration-1000 group-hover:opacity-40"></div>
                            <div className="relative flex aspect-square w-[340px] flex-col items-center justify-center rounded-3xl border border-white/10 bg-[#1F292E]/60 p-10 text-center shadow-2xl backdrop-blur-md transition-all duration-500 ease-out hover:scale-105">
                                <div className="mb-8 flex h-24 w-24 items-center justify-center rounded-2xl bg-emerald-500/20 text-emerald-400 shadow-inner">
                                    <User size={48} className="drop-shadow-md" />
                                </div>
                                <h3 className="mb-3 text-2xl font-bold text-white">Your Profile</h3>
                                <p className="text-emerald-100/70">A complete profile attracts top students. Make your first impression count.</p>
                            </div>
                        </div>
                    </div>
                );
                    ...
                    <div className="flex h-full w-full items-center justify-center">
                        <div className="relative group perspective-1000">
                            ...
                            <div className="relative flex aspect-square w-[340px] flex-col items-center justify-center rounded-3xl border border-white/10 bg-[#1F292E]/60 p-10 text-center shadow-2xl backdrop-blur-md transition-all duration-500 ease-out hover:scale-105">
                                ...
                                <p className="text-emerald-100/70">Detail your teaching methods to find students who match your style perfectly.</p>
                            </div>
                        </div>
                    </div>
                );
                    ...
                    <div className="flex h-full w-full items-center justify-center">
                        <div className="relative group perspective-1000">
                            ...
                            <div className="relative flex aspect-square w-[340px] flex-col items-center justify-center rounded-3xl border border-white/10 bg-[#1F292E]/60 p-10 text-center shadow-2xl backdrop-blur-md transition-all duration-500 ease-out hover:scale-105">
                                ...
                                <p className="text-emerald-100/70">Set your hours and let our system automatically manage your bookings.</p>
                            </div>
                        </div>
                    </div>
                );
