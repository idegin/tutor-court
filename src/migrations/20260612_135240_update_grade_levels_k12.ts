...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  -- Map simplified grades to K-12 stages
  UPDATE "users" SET "grade_level" = CASE "grade_level"
    WHEN 'early_years' THEN 'kindergarten'
    WHEN 'lower_primary' THEN 'grade_1'
    WHEN 'upper_primary' THEN 'grade_4'
    WHEN 'junior_high_school' THEN 'grade_7'
    WHEN 'senior_high_school' THEN 'grade_10'
    ELSE "grade_level"
  ...
  CREATE TYPE "public"."enum_users_grade_level" AS ENUM('kindergarten', 'grade_1', 'grade_2', 'grade_3', 'grade_4', 'grade_5', 'grade_6', 'grade_7', 'grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12', 'others');
  ...
  CREATE TYPE "public"."enum_tutor_profiles_grades_taught" AS ENUM('kindergarten', 'grade_1', 'grade_2', 'grade_3', 'grade_4', 'grade_5', 'grade_6', 'grade_7', 'grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12', 'others');
  ...
  CREATE TYPE "public"."enum_subjects_grade_levels" AS ENUM('kindergarten', 'grade_1', 'grade_2', 'grade_3', 'grade_4', 'grade_5', 'grade_6', 'grade_7', 'grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12', 'others');
  ...
  CREATE TYPE "public"."enum_bookings_grade_level" AS ENUM('kindergarten', 'grade_1', 'grade_2', 'grade_3', 'grade_4', 'grade_5', 'grade_6', 'grade_7', 'grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12', 'others');
  ...
  CREATE TYPE "public"."enum_students_grade_level" AS ENUM('kindergarten', 'grade_1', 'grade_2', 'grade_3', 'grade_4', 'grade_5', 'grade_6', 'grade_7', 'grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12', 'others');
  ...
  ALTER TABLE "classes" ALTER COLUMN "grade_level" SET DEFAULT 'grade_1'::text;
  CREATE TYPE "public"."enum_classes_grade_level" AS ENUM('kindergarten', 'grade_1', 'grade_2', 'grade_3', 'grade_4', 'grade_5', 'grade_6', 'grade_7', 'grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12', 'others');
  ALTER TABLE "classes" ALTER COLUMN "grade_level" SET DEFAULT 'grade_1'::"public"."enum_classes_grade_level";
  ...
  CREATE TYPE "public"."enum_assessments_grade_level" AS ENUM('kindergarten', 'grade_1', 'grade_2', 'grade_3', 'grade_4', 'grade_5', 'grade_6', 'grade_7', 'grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12', 'others');
