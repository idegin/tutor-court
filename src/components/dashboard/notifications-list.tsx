...
export function NotificationsList({ userRole }: NotificationsListProps) {
  ...
  const getSubtitle = () => {
    if (userRole === 'tutor') {
      return 'Stay up to date with your classes and students.'
    }
    if (userRole === 'parent') {
      return 'Stay up to date with your children\'s classes, reminders, and activities.'
    }
    return 'Stay up to date with your classes, assessments, and teacher updates.'
  }
